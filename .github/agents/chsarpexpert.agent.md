...
agents: [TDD Green Phase, TDD Red Phase]
...
- Run the TDD Red Phase agent and TDD Green Phase agent for red and green phases of TDD
- Follow the principles and execution guidelines in the respective agents.
