...
public class DatabaseInitializer
{
    ...
    public void InitializeDatabase()
    {
        ...
        if (!dbContext.Regions.Any())
        {
            ...
            var europeanRegion = new Region
            {
                Name = "Europe",
                Description = "European mythologies including Norse, Greek, and Roman traditions",
            ...
            dbContext.Regions.Add(europeanRegion);

            // Save changes
            dbContext.SaveChanges();

            Console.WriteLine("Database initialized with European region and mythologies");
        }
        _initialized = true;
    }
}
